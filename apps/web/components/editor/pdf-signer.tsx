...
import { createField } from "@insurahub/features/editor";
import { createOrUpdateField, deleteField, signDocument } from "@insurahub/lib/api";
import { NEXT_PUBLIC_WEBAPP_URL } from "@insurahub/lib/constants";
      ...
      <div className="bg-blue-400 p-4">
        <div className="flex">
          <div className="flex-shrink-0 flex gap-x-2 items-center">
            <Image src={Logo} alt="insurahub" width={32} height={32} />
            <h2 className="text-2xl font-semibold">insurahub</h2>
          </div>
