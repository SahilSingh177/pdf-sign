...
import { truncate } from "@insurahub/lib/helpers";
import prisma from "@insurahub/prisma";
import { Button, IconButton } from "@insurahub/ui";
...
const Signed: NextPageWithLayout = (props: any) => {
  ...
  return (
    <>
      <Head>
        <title>Sign | insurahub</title>
      </Head>
      <div className="mx-auto w-fit px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <CheckBadgeIcon className="text-blue-500 mr-1 inline w-10"></CheckBadgeIcon>
        <h1 className="text-blue-500 inline align-middle text-base font-medium">It's done!</h1>
