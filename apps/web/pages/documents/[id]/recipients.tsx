...
import { NEXT_PUBLIC_WEBAPP_URL, classNames } from "@insurahub/lib";
import { createOrUpdateRecipient, deleteRecipient, sendSigningRequests } from "@insurahub/lib/api";
import { getDocument } from "@insurahub/lib/query";
import { getUserFromToken } from "@insurahub/lib/server";
import { Breadcrumb, Button, Dialog, IconButton, Tooltip } from "@insurahub/ui";
...
const RecipientsPage: NextPageWithLayout = (props: any) => {
  const title: string = `"` + props?.document?.title + `"` + "Recipients | insurahub";
